...
const ActionComponent = (row: RoleSetupTableData, setInitialValues: React.Dispatch<
    React.SetStateAction<RoleSetupFormSchema>
>) => {
...
const RoleSetupTable = ({ initialValues, setInitialValues }: RoleSetupTableProps) => {
    const { data: roleList } = useGetAllRole()

    const { t } = useTranslation();
    const {
        mutate: changeRoleStatus,
        isLoading: changeRoleStatusLoading,
    } = useChangeRoleStatus()
